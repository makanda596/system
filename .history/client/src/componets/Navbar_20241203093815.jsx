            ...
            <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
                ...
                <div className="flex space-x-6 items-center text-white">
                    ...
                    <Link to="/alert" className="relative cursor-pointer">
                        <span className="absolute left-0 inline-block  top-[-10px] ring-2 ">
                            {alert > 0 ? <p className='bg-red-500 rounded-full w-4.5 h-4.5'>{alert} </p> : <p className='bg-green-500 ring-green'>0</p>}
                        </span>
                        <AnnouncementIcon className='w-100' />
                    </Link>
                    {/* Payments Link */}
