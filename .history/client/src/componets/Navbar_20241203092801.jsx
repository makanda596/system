        ...
        <nav className="bg-blue-600 shadow-md">
            <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
                ...
                <div className="flex space-x-6 items-center text-white">
                    ...
                    <div className="relative">
                        <span className="absolute top-0 right-0 inline-block w-2.5 h-2.5 rounded-full ring-2 ">
                            hello{alert.length > 1 ? <p className='bg-red-500 '>{alert.length} </p> : <p className='bg-green-500 ring-green'>0</p>}
                        </span>
                        <AnnouncementIcon />
                    </div>
                    {/* Payments Link */}
