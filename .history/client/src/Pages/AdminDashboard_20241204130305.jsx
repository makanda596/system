...
function AdminDashboard() {
    ...
    useEffect(() => {
        ...
        const fetchTenants = async () => {
            try {
                ...
                const response = await axios.get("http://localhost:5000/signup", userphone);
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
                        ...
                        <tbody>
                            ...
                            {users.map((user, index) => (
                                <tr
                                    ...
                                    <td className="border px-4 py-2">{user.userphone}</td>

                                    <td className="border px-4 py-2 text-center">{user.UserRoomNumber} </td>
                                    ...
                                    <td className="border px-4 py-2 text-center bg-green-500 rounded-md"><button className="bg-green-500 text-white">UPDATE</button></td>

                                    <td className="border px-4 py-2 text-center bg-red-500 rounded-md"><button className="text-white">DELETE</button></td>
            ...
            <button className="text-white bg-red-600" onClick={deletelist}>CLEAR ALL</button>
        </div >
    );
}
