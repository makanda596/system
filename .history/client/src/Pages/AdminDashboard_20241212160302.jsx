...
function AdminDashboard() {
    ...
    const handleDelete = async (userId) => {
        try {
            ...
            user(user.filter((user) => user._id !== userId)); // Update state after deletion
    ...
    const handleUpdate = async (userId) => {
        ...
        try {
            ...
            user(user.map((user) => (user._id === userId ? response.data.updatedUser : user))); // Update state with new details
        } catch (error) {
