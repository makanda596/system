                        ...
                        <tbody>
                            ...
                            {users.map((user, index) => (
                                ...
                                >
                                    ...
                                    <td className="border px-4 py-2 ">{rentStatus === "paid" ? <p className="text-green-400">{rentStatus}</p> : <p className="text-red">Not paid</p>}</td>
                                    <td className="border px-4 py-2 text-center">{user.moveIn}
                                        {/* {new Date(user.moveDate).toLocaleDateString()} */}
                                    </td>
                                </tr>
                            ))}
                        </tbody>
